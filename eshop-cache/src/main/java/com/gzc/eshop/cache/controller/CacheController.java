package com.gzc.eshop.cache.controller;
...
import com.gzc.eshop.cache.rebuild.RebuildCacheQueue;
...
public class CacheController {
    ...
    public void testPutCache(ProductInfo productInfo){
        ...
        cacheService.setLocalCache(productInfo);
    }

    @RequestMapping("/testGetCache")
    @ResponseBody
    public ProductInfo testGetCache(Long id){
        ProductInfo productInfo = cacheService.getLocalCahce(id);
        System.out.println(productInfo.getId() + ":" + productInfo.getName());
        return productInfo;
    }
