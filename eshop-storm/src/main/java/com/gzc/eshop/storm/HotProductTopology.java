package com.gzc.eshop.storm;

import com.gzc.eshop.storm.bolt.LogParseBolt;
import com.gzc.eshop.storm.bolt.ProductCountBolt;
import com.gzc.eshop.storm.spout.AccessLogKafkaSpout;
...
public class HotProductTopology {
    ...
    public static void main(String[] args) {
        ...
        builder.setBolt("",new ProductCountBolt(),2)
                .setNumTasks(2)
